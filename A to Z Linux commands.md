...
A	&			Start a new process in the background
...
O	open		Open a file in its default application
 	op			Operator access
...
V	vdir		Verbosely list directory contents ('ls -l -b')
 	vi			Text Editor
	vim 		Test Editor
...
Y	yes			Print a string until interrupted
	youtube-dl	download videos and also extract MP3 tracks from YouTube.com and a few more sites
